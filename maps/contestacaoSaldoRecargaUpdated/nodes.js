...
//---------------------Update----------------------
    ...
    verificaConsultarSaldoFalhaAcolhimento: contestacaoSaldoRecarga.newNode('switch', {
        name: 'Verifica se o cliente quer consultar saldo não havendo sucesso na consulta do serviço recarga/saldo no acolhimento',
        pathCases: ['Intenção Consultar Saldo (Falha Serv. Recarga/Saldo acolhimento)', 'Intenção não é Consultar Saldo (Falha Serv. Recarga/Saldo acolhimento)']
    }),

    respostaIntencaoConsultarSaldoFalhaAcolhimento: contestacaoSaldoRecarga.newNode('node', {
        name: 'URA informa que não foi possivel consultar o saldo',
        expectedMessage: 'URA informa que não foi possivel consultar o saldo devido a uma instabilidade no sistema e que o cliente pode acessar esta informação no APP;'
    }),
