...
const nodes = {
    ...
    viaDeAcesso: contratacaoPacoteDados.newNode('node', {
        ...
        stepMessage: 'Veio de #desambiguadorContratacaoPacoteDados ou redirecionado dos fluxos de Acolhimento ou Problemas Técnicos',
...
//-----------------------------------------------------INICIO PRÉ-TOP---------------------------------
    ...
    verificaServiçosNoAcolhimento: contratacaoPacoteDados.newNode('switch', {
        name: 'Serviços consultados no acolhimento?',
...
//-----------------------------------------------------FIM PRÉ-TOP---------------------------------
    ...
    verificaConsultaQuota: contratacaoPacoteDados.newNode('switch', {
        name: 'Retorno do serviço quota ok no acolhimento?',
        pathCases: ['Sucesso no serv. Quota (acolhim.)', 'Falha no serv. Quota (acolhim.)']
    }),
...
//----------------------------------------------------------PACOTE MINIMO----------------------------------------------
    ...
    verificaDificuldadeUsarInternet: contratacaoPacoteDados.newNode('switch', {
        name: 'Verifica se cliente possui alguma dificuldade para acessar a internet',
        pathCases: ['Input - Dificuldade na internet', 'Input - Sem dificuldades na internet', 'Input - Não reconhecido(dificuldades)']
    }),
    ...
    repeteInputDificuldadeUsarInternet: contratacaoPacoteDados.newNode('switch', {
        name: 'Verifica se cliente possui alguma dificuldade para acessar a internet',
        pathCases: ['Dificuldade na internet (após repetir)', 'Sem dificuldades na internet (após repetir)', 'Não reconhecido (após repetir)']
    }),

    respostaRepeteDificuldadeUsarInternet: contratacaoPacoteDados.newNode('node', {
        name: 'URA repete a pergunta.',
        expectedMessage: 'URA repete a pergunta sobre estar com dificuldade para usar a internet;'
    }),

    encaminhaFluxoSuporteTecnico: contratacaoPacoteDados.newNode('node', {
        name: 'URA encaminha para o fluxo de Suporte Técnico.',
        expectedMessage: 'URA encaminha para o fluxo de Suporte Técnico;'
    }).turnTargetNode(),
