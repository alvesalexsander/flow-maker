...
const nodes = {
    ...
    verificaInputCliente: adesaoOferta.newNode('switch', {
        name: 'Verifica Input',
        pathCases: ['Input Inválido (2x)', 'Input Inválido -> Válido', 'Input Válido']
    }),
...
// ---------------------------- UPDATE --------------------------
    ...
    verificaConsultaPlanDataAction: adesaoOferta.newNode('switch', {
        name: 'Chamada do serviço Plan Data Action',
        pathCases: ['Sucesso no Plan Data Action', 'Falha no serviço Plan Data Action']
    }),

    respostaConsultaPlanDataActionFalha: adesaoOferta.newNode('node', {
        name: 'URA informa que não vai conseguir prosseguir por uma instabilidade nos sistema',
        expectedMessage: 'URA informa que não vai conseguir prosseguir por uma instabilidade nos sistema e que o cliente pode conhecer outras ofertas no site;'
    }),

    verificaSMSBeta: adesaoOferta.newNode('switch', {
        name: 'Envia SMS Beta',
        pathCases: ['Sucesso no SMS Beta', 'Falha no SMS Beta']
    }),
